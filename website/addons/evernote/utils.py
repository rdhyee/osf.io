# -*- coding: utf-8 -*-
"""Utility functions for the Evernote add-on.
"""
...
def serialize_settings(node_settings, current_user):
    """
    View helper that returns a dictionary representation of a EvernoteNodeSettings record. Provides the return value for the evernote config endpoints.
    """
